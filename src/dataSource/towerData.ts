...
export default [
  ...
  // {name: '两发豌豆', money: 200, saleMoney: 100, r: 150, damage: 1, targetNum: 1, rate: 450, speed: 8, bSize: {w:20,h:20},   audioKey: 'pea-two',  img: new URL("../assets/img/plant/pea_2_icon.gif", import.meta.url).href, bulletImg: new URL("../assets/img/plant/bullet.png", import.meta.url).href},
