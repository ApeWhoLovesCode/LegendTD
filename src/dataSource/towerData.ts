...
const towerArr: TowerType[] = [
  ...
  { name: 'jin',      money: 500, saleMoney: 250, r: 6, damage: 6, targetNum: 1, rate: 1200, speed: 0.2, bSize: {w:0.4,h:0.4}, audioKey: 'jin', img: requireImg('tower/jin.png'), bulletImg: requireImg('tower/bullet3.png'), cover: requireImg("tower/jin-cover.png")},
  { name: 'ez',       money: 500, saleMoney: 250, r: 4.5, damage: 2, targetNum: 1, rate: 1200, speed: 0.14, bSize: {w:2,h:2}, isThrough: true, bulletInitDeg: 170, audioKey: 'ez', img: requireImg('tower/ez.png'), bulletImg: requireImg('tower/bullet-ez.png'), cover: requireImg("tower/ez-cover.png")},
  ...
  { name: 'delaiwen', money: 500, saleMoney: 250, r: 4, damage: 8, targetNum: 1, rate: 1200, speed: 0.14, bSize: {w:1,h:1}, isThrough: true, isCharging: false, bulletInitDeg: 170, audioKey: 'delaiwen', img: requireImg('tower/delaiwen.png'), bulletImg: requireImg('tower/bullet-delaiwen.png'), cover: requireImg("tower/delaiwen-cover.png")}
]
...
export const towerStaticData: {[key in TowerName]: TowerStaticItem} = {
  ...
  'delaiwen': { name: '德莱文', explain: '往前方丢出会回收的斧头，斧头会处决生命值低于10%的敌人，并有10%几率使该敌人奖励翻倍。' },
}
