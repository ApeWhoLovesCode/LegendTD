...
export default [
  ...
  { name: 'fengche',  money: 500, saleMoney: 250, r: 180, damage: 2, targetNum: 1, rate: 1000, speed: 6.5, bSize: {w:50,h:50}, isThrough: true, audioKey: 'fengche', img: requireImg('tower/fengche.png'), bulletImg: requireImg('tower/bullet-fengche.png')},
  ...
  { name: 'ez',       money: 500, saleMoney: 250, r: 250, damage: 2, targetNum: 1, rate: 1000, speed: 6.5, bSize: {w:100,h:100}, isThrough: true, bulletInitDeg: 170, audioKey: 'ez', img: requireImg('tower/ez.png'), bulletImg: requireImg('tower/bullet-ez.png')},
  {
