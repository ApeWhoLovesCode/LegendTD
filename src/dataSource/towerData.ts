...
export default [
  ...
  { name: '茄子',     money: 500, saleMoney: 250, r: 300, damage: 6, targetNum: 1, rate: 1200, speed: 12, bSize: {w:20,h:20}, audioKey: 'qizi-wujie', img: new URL("../assets/img/plant/qiezi.png", import.meta.url).href, bulletImg: new URL("../assets/img/plant/bullet3.png", import.meta.url).href},
  ...
  {
    name: 'lanbo',    money: 600, saleMoney: 300, r: 250, damage: 1, targetNum: 99, rate: 2000, speed: 2, bSize: {w:50,h:50},   audioKey: 'lanbo',
    img: new URL("../assets/img/tower/lanbo.png", import.meta.url).href, cover: new URL("../assets/img/tower/lanbo-cover.png", import.meta.url).href, bulletImg: new URL("../assets/img/tower/fire.png", import.meta.url).href
  },
