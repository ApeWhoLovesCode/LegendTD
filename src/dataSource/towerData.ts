...
export default [
  ...
  { name: 'fengche',  money: 500, saleMoney: 250, r: 180, damage: 2, targetNum: 1, rate: 1000, speed: 6.5, bSize: {w:50,h:50}, isThrough: true, audioKey: 'fengche', img: new URL("../assets/img/tower/fengche.png", import.meta.url).href, bulletImg: new URL("../assets/img/tower/bullet-fengche.png", import.meta.url).href},
  { name: 'ez',       money: 500, saleMoney: 250, r: 250, damage: 2, targetNum: 1, rate: 1000, speed: 6.5, bSize: {w:50,h:50}, isThrough: true, bulletInitDeg: 170, audioKey: 'ez', img: new URL("../assets/img/tower/ez.png", import.meta.url).href, bulletImg: new URL("../assets/img/tower/bullet-ez.png", import.meta.url).href},
  {
  ...
  { name: 'aixi',     money: 800, saleMoney: 400, r: 200, damage: 1, targetNum: 9, rate: 1200, speed: 6, slow: {num: 2, time: 5000}, bSize: {w:20,h:20}, bulletInitDeg: 20, audioKey: 'aixi', img: new URL("../assets/img/tower/aixi.png", import.meta.url).href, bulletImg: new URL("../assets/img/tower/bullet2.png", import.meta.url).href},
] as TowerType[]
