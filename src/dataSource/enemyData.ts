...
const enemyArr: EnemyType[] = [
  {name: 'zombies-flag',   w: 1.5, h: 1.5, curSpeed: 0.03, speed: 0.03, reward: 50, hp: {cur: 10, sum: 10, size: 0.16}, audioKey: 'pvz-pieces', imgType: 'gif', imgSource: _requireCDN('zombies_0_move.gif'), isForward: true, isFlip: false},
  ...
  {name: 'zombies-dance',  w: 1.7, h: 1.7, curSpeed: 0.04, speed: 0.04, reward: 80, hp: {cur: 350, sum: 350, size: 0.16}, skill: {time: 8000}, audioKey: 'pvz-dance', imgType: 'gif', imgSource: _requireCDN('zombies_7_move.gif'), isForward: true, isFlip: false},
  ...
  {name: 'fulisha',        w: 1.8, h: 1.8,  curSpeed: 0.03, speed: 0.03, reward: 150, hp: {cur: 800, sum: 800, size: 0.16}, skill: {time: 6000}, audioKey: 'pvz-fulisha', imgType: 'png', imgSource: _requireCDN('fulisha.png'), isForward: true, isFlip: false},
  ...
  {name: 'kunkun',         w: 1.8, h: 1.8,  curSpeed: 0.04, speed: 0.04, reward: 160, hp: {cur: 800, sum: 800, size: 0.16}, skill: {time: 10000}, audioKey: 'kunkun', imgType: 'gif', imgSource: _requireCDN('kunkun.gif'), isForward: false, isFlip: false},
  ...
  {name: 'zomebies-boom',  w: 1.5, h: 1.5, curSpeed: 0.03, speed: 0.03, reward: 200, hp: {cur: 400, sum: 400, size: 0.16}, skill: {time: 3000, r: 2, animation: {cur: 120, sum: 120}, damage: 10, img: _requireCDN('zomebies-boom-skill.gif')}, audioKey: 'pvz-boom', imgType: 'gif', imgSource: _requireCDN('zomebies-boom.gif'), dieImg: _requireCDN('zomebies-boom-skill2.gif'), isForward: true, isFlip: false},
]
