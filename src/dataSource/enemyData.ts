...
const enemyArr: EnemyType[] = [
  ...
  {name: 'ice-car',        w: 1.8, h: 1.8,  curSpeed: 0.04, speed: 0.04, reward: 110, hp: {cur: 200, sum: 200, size: 0.16}, skill: {time: 5000, r: 3, keepTime: 2000, animation: {cur: 120, sum: 120}}, audioKey: 'pvz-ice-car', imgType: 'gif', imgSource: _requireCDN('zombies_9_move.gif'), isForward: true, isFlip: false},
  ...
  {name: 'godzilla',       w: 1.8, h: 1.8, curSpeed: 0.03, speed: 0.03, reward: 200, hp: {cur: 400, sum: 400, size: 0.16}, skill: {time: 8000, animation: {cur: 60, sum: 60}, damage: 5}, audioKey: 'pvz-godzilla', imgType: 'png', imgSource: _requireCDN('godzilla.png'), isForward: false, isFlip: true},
]
