...
const enemyArr: EnemyType[] = [
  ...
  {name: '舞王',     x: 0, y: 0, w: 1.7, h: 1.7, curFloorI: 0, isForward: true, isFlip: false, curSpeed: 0.04, speed: 0.04, reward: 80, hp: {cur: 280, sum: 280, size: 0.16},     skill: {time: 6000}, audioKey: 'pvz-dance', type: 'gif', imgSource: requireCDN('zombies_7_move.gif', prefix), imgList: [], imgIndex: 0},
  ...
  {name: '舞王小兵', x: 0, y: 0, w: 1.5, h: 1.5, curFloorI: 0, isForward: true, isFlip: false,  curSpeed: 0.04, speed: 0.04, reward: 5, hp: {cur: 20, sum: 20, size: 0.16},       audioKey: 'pvz-dance-little', type: 'gif', imgSource: requireCDN('zombies_10_move.gif', prefix), imgList: [], imgIndex: 0},
  {name: '小鬼僵尸', x: 0, y: 0, w: 1.5, h: 1.5, curFloorI: 0, isForward: true, isFlip: false,  curSpeed: 0.06, speed: 0.06, reward: 5, hp: {cur: 15, sum: 15, size: 0.16},       audioKey: 'pvz-little', type: 'gif', imgSource: requireCDN('zombies_11_move.gif', prefix), imgList: [], imgIndex: 0},
  {name: '坤坤',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: false,  curSpeed: 0.04, speed: 0.04, reward: 160, hp: {cur: 700, sum: 700, size: 0.16},     skill: {time: 10000}, audioKey: 'kunkun', type: 'gif', imgSource: requireCDN('kunkun.gif', prefix), imgList: [], imgIndex: 0},
