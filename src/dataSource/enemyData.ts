...
const enemyArr: EnemyType[] = [
  ...
  {name: 'ice-car',     x: 0, y: 0, w: 1.8, h: 1.8, isForward: true, isFlip: false,  curSpeed: 0.06, speed: 0.06, reward: 80, hp: {cur: 25000, sum: 25000, size: 0.16},   skill: {time: 2000, r: 3, keepTime: 2000, animation: {cur: 100, sum: 100}}, audioKey: 'pvz-car', imgType: 'gif', imgSource: _requireCDN('zombies_9_move.gif'), level: 1},
  ...
  {name: 'rabbish-2',   x: 0, y: 0, w: 1.8, h: 1.8, isForward: false, isFlip: true,  curSpeed: 0.04, speed: 0.04, reward: 100, hp: {cur: 400, sum: 400, size: 0.16},   skill: {time: 3000, r:2, animation: {cur: 80, sum: 80}},  audioKey: 'rabbish-2', imgType: 'gif', imgSource: _requireCDN('rabbish_2.gif'), level: 1},
