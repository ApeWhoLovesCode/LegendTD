...
const enemyArr: EnemyType[] = [
  ...
  {name: '舞王',     x: 0, y: 0, w: 1.7, h: 1.7, curFloorI: 0, isForward: true, isFlip: false, curSpeed: 0.04, speed: 0.04, reward: 100, hp: {cur: 250, sum: 250, size: 0.16},     skill: {time: 6000}, audioKey: 'pvz-dance', type: 'gif', imgSource: requireCDN('zombies_7_move.gif', prefix), imgList: [], imgIndex: 0},
  ...
  {name: '坤坤',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: false,  curSpeed: 0.04, speed: 0.04, reward: 150, hp: {cur: 700, sum: 700, size: 0.16},     skill: {time: 10000}, audioKey: 'kunkun', type: 'gif', imgSource: requireCDN('kunkun.gif', prefix), imgList: [], imgIndex: 0},
