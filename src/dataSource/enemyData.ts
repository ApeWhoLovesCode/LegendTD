...
const enemyArr: EnemyType[] = [
  ...
  {name: '舞王',     x: 0, y: 0, w: 1.7, h: 1.7, isForward: true, isFlip: false, curSpeed: 0.04, speed: 0.04, reward: 80, hp: {cur: 350, sum: 350, size: 0.16},     skill: {time: 10000}, audioKey: 'pvz-dance', imgType: 'gif', imgSource: _requireCDN('zombies_7_move.gif'), level: 1},
  ...
  {name: '弗利萨',   x: 0, y: 0, w: 1.8, h: 1.8, isForward: true, isFlip: false,  curSpeed: 0.03, speed: 0.03, reward: 150, hp: {cur: 800, sum: 800, size: 0.16}, skill: {time: 5000}, audioKey: 'pvz-fulisha', imgType: 'png', imgSource: _requireCDN('fulisha.png'), level: 1},
