...
const enemyArr: EnemyType[] = [
  ...
  {name: 'afu',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: true,  curSpeed: 0.03, speed: 0.03, reward: 100, hp: {cur: 500, sum: 500, size: 0.16}, audioKey: 'afu', type: 'png', imgSource: new URL("../assets/img/zombies/afu.png", import.meta.url).href, imgList: [], imgIndex: 0},
  ...
  {name: '坤坤',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: false,  curSpeed: 0.04, speed: 0.04, reward: 250, hp: {cur: 700, sum: 700, size: 0.16},     skill: {time: 10000}, audioKey: 'kunkun', type: 'png', imgSource: new URL("../assets/img/zombies/kunkun.png", import.meta.url).href, imgList: [], imgIndex: 0},
  // {name: '坤坤',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: false,  curSpeed: 0.04, speed: 0.04, reward: 250, hp: {cur: 700, sum: 700, size: 0.16},     skill: {time: 10000}, audioKey: 'kunkun', type: 'gif', imgSource: new URL("../assets/img/zombies/kunkun.gif", import.meta.url).href, imgList: [], imgIndex: 0},
  {name: 'rabbish',     x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: true,  curSpeed: 0.04, speed: 0.04, reward: 250, hp: {cur: 300, sum: 300, size: 0.16},     audioKey: 'rabbish', type: 'gif', imgSource: new URL("../assets/img/zombies/rabbish_1.gif", import.meta.url).href, imgList: [], imgIndex: 0},
  {name: 'rabbish-2',   x: 0, y: 0, w: 1.8, h: 1.8, curFloorI: 0, isForward: false, isFlip: true,  curSpeed: 0.04, speed: 0.04, reward: 250, hp: {cur: 500, sum: 500, size: 0.16},     audioKey: 'rabbish-2', type: 'gif', imgSource: new URL("../assets/img/zombies/rabbish_2.gif", import.meta.url).href, imgList: [], imgIndex: 0},
]
