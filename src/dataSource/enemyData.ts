...
export default [
  {name: '僵尸',     x: 0, y: 0, w: 75, h: 75, curFloorI: 0, curSpeed: 1.5, speed: 1.5, reward: 100, hp: {cur: 10, sum: 10, size: 8},    audioKey: 'pvz-pieces', type: 'gif', imgSource: new URL("../assets/img/zombies/zombies_0_move.gif", import.meta.url).href, imgList: [], imgIndex: 0},
