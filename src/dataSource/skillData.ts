...
export default [
  ...
  {name: '肉弹冲击', instructions: '眩晕场上所有敌人6秒，并造成1点伤害', icon: 'icon-jianshen-daduzi-pijiudu', money: 5, damage: 1, cd: 6000, curTime: 0, audioKey: 'ma-roudan', isShow: false, showTime: 2000 },
